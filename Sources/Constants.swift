...
extension String {
    static let translations: [String: [AppLanguage: String]] = {
        ...
        dict["Pick a Theme Color"] = [.chinese: "主题颜色", .traditionalChinese: "主題顏色", .english: "Theme Color", .japanese: "テーマカラー", .korean: "테마 색상", .spanish: "Color del tema", .german: "Themenfarbe", .russian: "Цвет темы", .italian: "Colore del tema"]
        ...
        dict["Language"] = [.chinese: "多语言 / Language", .traditionalChinese: "多語言 / Language", .english: "Language / 多语言", .japanese: "言語 / 多言", .korean: "언어 / 多语言", .spanish: "Idioma / 多语言", .german: "Sprache / 多语言", .russian: "Язык / Английский", .italian: "Lingua / 多语言"]
        ...
        dict["记录心情"] = [.chinese: "记录心情", .traditionalChinese: "記錄心情", .english: "Record Mood", .japanese: "気分を記録する", .korean: "기분 기록하기", .spanish: "Grabar estado de ánimo", .german: "Stimmung aufzeichnen", .russian: "Запись настроения", .italian: "Registra l'umore"]
        ...
        dict["当前心情"] = [.chinese: "当前心情", .traditionalChinese: "目前心情", .english: "Current Mood", .japanese: "現在の気分", .korean: "현재 기분", .spanish: "Estado de ánimo actual", .german: "Aktuelle Stimmung", .russian: "Текущее настроение", .italian: "Umore attuale"]
        ...
        dict["想法 (选填)"] = [.chinese: "想法 (选填)", .traditionalChinese: "想法 (選填)", .english: "Thoughts (Optional)", .japanese: "感想（任意）", .korean: "생각(선택사항)", .spanish: "Pensamientos (opcional)", .german: "Gedanken (optional)", .russian: "Мысли (необязательно)", .italian: "Pensieri (facoltativo)"]
        ...
        dict["写下这一刻的想法..."] = [.chinese: "写下这一刻的想法...", .traditionalChinese: "寫下這一刻的想法...", .english: "Write down your thoughts...", .japanese: "あなたの考えを書き留めてください...", .korean: "당신의 생각을 적어보세요...", .spanish: "Escribe tus pensamientos...", .german: "Schreiben Sie Ihre Gedanken auf...", .russian: "Запишите свои мысли...", .italian: "Scrivi i tuoi pensieri..."]
        ...
        dict["图片 (选填)"] = [.chinese: "图片 (选填)", .traditionalChinese: "圖片 (選填)", .english: "Image (Optional)", .japanese: "画像 (オプション)", .korean: "이미지(선택사항)", .spanish: "Imagen (opcional)", .german: "Bild (optional)", .russian: "Изображение (необязательно)", .italian: "Immagine (facoltativa)"]
        ...
        dict["添加图片"] = [.chinese: "添加图片", .traditionalChinese: "新增圖片", .english: "Add Image", .japanese: "画像を追加", .korean: "이미지 추가", .spanish: "Agregar imagen", .german: "Bild hinzufügen", .russian: "Добавить изображение", .italian: "Aggiungi immagine"]
        ...
        dict["记录"] = [.chinese: "记录", .traditionalChinese: "記錄", .english: "Save", .japanese: "保存", .korean: "저장", .spanish: "Guardar", .german: "Speichern", .russian: "Сохранить", .italian: "Salva"]
        ...
        dict["激动"] = [.chinese: "激动", .traditionalChinese: "激動", .english: "Excited", .japanese: "興奮した", .korean: "흥분된다", .spanish: "emocionado", .german: "Aufgeregt", .russian: "взволнованный", .italian: "Emozionato"]
        dict["excited"] = [.chinese: "激动", .traditionalChinese: "激動", .english: "Excited", .japanese: "興奮した", .korean: "흥분된다", .spanish: "emocionado", .german: "Aufgeregt", .russian: "взволнованный", .italian: "Emozionato"]
        ...
        dict["开心"] = [.chinese: "开心", .traditionalChinese: "開心", .english: "Happy", .japanese: "ハッピー", .korean: "행복하다", .spanish: "feliz", .german: "Glücklich", .russian: "Счастливый", .italian: "Felice"]
        dict["happy"] = [.chinese: "开心", .traditionalChinese: "開心", .english: "Happy", .japanese: "ハッピー", .korean: "행복하다", .spanish: "feliz", .german: "Glücklich", .russian: "Счастливый", .italian: "Felice"]
        ...
        dict["一般"] = [.chinese: "一般", .traditionalChinese: "一般", .english: "Normal", .japanese: "ノーマル", .korean: "보통", .spanish: "normales", .german: "Normal", .russian: "Нормальный", .italian: "Normale"]
        ...
        dict["失落"] = [.chinese: "失落", .traditionalChinese: "失落", .english: "Down", .japanese: "ダウン", .korean: "아래로", .spanish: "abajo", .german: "Runter", .russian: "Вниз", .italian: "Giù"]
        ...
        dict["愤怒"] = [.chinese: "愤怒", .traditionalChinese: "憤怒", .english: "Angry", .japanese: "怒っている", .korean: "화난", .spanish: "enojado", .german: "Wütend", .russian: "Злой", .italian: "Arrabbiato"]
        ...
        dict["兑换码 / Redeem Code"] = [.chinese: "使用兑换码兑换会员", .traditionalChinese: "使用兌換碼兌換會員", .english: "Redeem Offer Code", .japanese: "オファーコードを引き換える", .korean: "혜택 코드 사용", .spanish: "Canjear código de oferta", .german: "Angebotscode einlösen", .russian: "Активировать код предложения", .italian: "Riscatta il codice dell'offerta"]
        ...
        dict["公里"] = [.chinese: "公里", .traditionalChinese: "公里", .english: "km", .japanese: "km", .korean: "킬로미터", .spanish: "kilómetros", .german: "km", .russian: "км", .italian: "km"]
        dict[L10n.m] = [.chinese: "米", .traditionalChinese: "米", .english: "m", .japanese: "メートル", .korean: "엠", .spanish: "m", .german: "m", .russian: "м", .italian: "m"]
        dict["米"] = [.chinese: "米", .traditionalChinese: "米", .english: "m", .japanese: "メートル", .korean: "엠", .spanish: "m", .german: "m", .russian: "м", .italian: "m"]
        ...
        dict["分钟"] = [.chinese: "分钟", .traditionalChinese: "分分鐘", .english: "mins", .japanese: "分", .korean: "분", .spanish: "minutos", .german: "Min", .russian: "минут", .italian: "min"]
        ...
        dict["小时"] = [.chinese: "小时", .traditionalChinese: "小時", .english: "hours", .japanese: "時間", .korean: "시간", .spanish: "horas", .german: "Stunden", .russian: "часы", .italian: "ore"]
        ...
        dict["次"] = [.chinese: "次", .traditionalChinese: "次", .english: "times", .japanese: "回", .korean: "배", .spanish: "veces", .german: "Zeiten", .russian: "раз", .italian: "volte"]
        ...
        dict["页"] = [.chinese: "页", .traditionalChinese: "頁", .english: "pages", .japanese: "ページ", .korean: "페이지", .spanish: "paginas", .german: "Seiten", .russian: "страницы", .italian: "pagine"]
        ...
        dict["天"] = [.chinese: "天", .traditionalChinese: "天", .english: "days", .japanese: "日", .korean: "일", .spanish: "dias", .german: "Tage", .russian: "дни", .italian: "giorni"]
        ...
        dict["周目标"] = [.chinese: "周目标", .traditionalChinese: "週目標", .english: "Weekly Target", .japanese: "週間目標", .korean: "주간 목표", .spanish: "Objetivo semanal", .german: "Wöchentliches Ziel", .russian: "Еженедельная цель", .italian: "Obiettivo settimanale"]
        dict["月目标"] = [.chinese: "月目标", .traditionalChinese: "月目標", .english: "Monthly Target", .japanese: "月間目標", .korean: "월간 목표", .spanish: "Objetivo mensual", .german: "Monatsziel", .russian: "Ежемесячная цель", .italian: "Obiettivo mensile"]
        ...
        dict["Unlock Little Habit"] = [.chinese: "解锁 TickDay", .traditionalChinese: "解鎖 TickDay", .english: "Unlock TickDay", .japanese: "TickDayのロックを解除する", .korean: "TickDay 잠금 해제", .spanish: "Desbloquear TickDay", .german: "Schalte TickDay frei", .russian: "Разблокировать TickDay", .italian: "Sblocca TickDay"]
        ...
        dict["Restore Purchase"] = [.chinese: "恢复购买", .traditionalChinese: "恢復購買", .english: "Restore", .japanese: "復元", .korean: "복원", .spanish: "Restaurar", .german: "Wiederherstellen", .russian: "Восстановить", .italian: "Ripristina"]
        ...
        dict["Cancel Check-in?"] = [.chinese: "操作", .traditionalChinese: "操作", .english: "Options", .japanese: "オプション", .korean: "옵션", .spanish: "Opciones", .german: "Optionen", .russian: "Опции", .italian: "Opzioni"]
        ...
        dict["统计概览"] = [.chinese: "统计概览", .traditionalChinese: "統計概覽", .english: "Statistics Overview", .japanese: "統計の概要", .korean: "통계 개요", .spanish: "Resumen de estadísticas", .german: "Statistikübersicht", .russian: "Обзор статистики", .italian: "Panoramica delle statistiche"]
        ...
        dict["首月免费"] = [.chinese: "首月免费", .traditionalChinese: "第一個月免費", .english: "First Month Free", .japanese: "初月無料", .korean: "첫 달 무료", .spanish: "Primer mes gratis", .german: "Erster Monat kostenlos", .russian: "Первый месяц бесплатно", .italian: "Primo mese gratuito"]
        ...
        dict["习惯名称"] = [.chinese: "习惯名称", .traditionalChinese: "習慣名稱", .english: "Habit Name", .japanese: "習慣名", .korean: "습관 이름", .spanish: "Nombre del hábito", .german: "Gewohnheitsname", .russian: "Название привычки", .italian: "Nome dell'abitudine"]
        ...
        dict["颜色和图标"] = [.chinese: "颜色和图标", .traditionalChinese: "顏色和圖標", .english: "Color and Icon", .japanese: "色とアイコン", .korean: "색상 및 아이콘", .spanish: "Color e icono", .german: "Farbe und Symbol", .russian: "Цвет и значок", .italian: "Colore e icona"]
        ...
        dict["颜色"] = [.chinese: "颜色", .traditionalChinese: "顏色", .english: "Color", .japanese: "色", .korean: "색상", .spanish: "Color", .german: "Farbe", .russian: "Цвет", .italian: "Colore"]
        ...
        dict["图标"] = [.chinese: "图标", .traditionalChinese: "圖示", .english: "Icon", .japanese: "アイコン", .korean: "아이콘", .spanish: "Icono", .german: "Symbol", .russian: "Значок", .italian: "Icona"]
        dict["选择图标"] = [.chinese: "选择图标", .traditionalChinese: "選擇圖示", .english: "Choose an Icon", .japanese: "アイコンを選択してください", .korean: "아이콘을 선택하세요", .spanish: "Elige un icono", .german: "Wählen Sie ein Symbol", .russian: "Выберите значок", .italian: "Scegli un'icona"]
        ...
        dict["目标规则"] = [.chinese: "目标规则", .traditionalChinese: "目標規則", .english: "Goal Rules", .japanese: "目標ルール", .korean: "목표 규칙", .spanish: "Reglas de objetivos", .german: "Zielregeln", .russian: "Правила целей", .italian: "Regole dell'obiettivo"]
        ...
        dict["打卡天数"] = [.chinese: "打卡天数", .traditionalChinese: "打卡天數", .english: "Check-in Days", .japanese: "チェックイン日", .korean: "체크인 날짜", .spanish: "Días de check-in", .german: "Check-in-Tage", .russian: "Дни заезда", .italian: "Giorni di check-in"]
        ...
        dict["美好的改变，从今天开始"] = [.chinese: "美好的改变，从今天开始", .traditionalChinese: "美好的改變，從今天開始", .english: "Beautiful changes begin today", .japanese: "美しい変化が今日始まります", .korean: "아름다운 변화는 오늘부터 시작됩니다", .spanish: "Hermosos cambios comienzan hoy", .german: "Heute beginnen schöne Veränderungen", .russian: "Красивые перемены начинаются сегодня", .italian: "Bellissimi cambiamenti iniziano oggi"]
        ...
        dict["开启你的第一个小习惯吧"] = [.chinese: "开启你的第一个小习惯吧", .traditionalChinese: "開啟你的第一個小習慣吧", .english: "Let's create your first habit", .japanese: "最初の習慣を作りましょう", .korean: "첫 번째 습관을 만들어보자", .spanish: "Creemos tu primer hábito", .german: "Lass uns deine erste Gewohnheit schaffen", .russian: "Давайте создадим вашу первую привычку", .italian: "Creiamo la tua prima abitudine"]
        ...
        dict["创建第一个习惯"] = [.chinese: "创建第一个习惯", .traditionalChinese: "創建第一個習慣", .english: "Create First Habit", .japanese: "最初の習慣を作る", .korean: "첫 번째 습관 만들기", .spanish: "Crea el primer hábito", .german: "Schaffen Sie eine erste Gewohnheit", .russian: "Создайте первую привычку", .italian: "Crea la prima abitudine"]
        ...
        dict["需要通知权限"] = [.chinese: "需要通知权限", .traditionalChinese: "需要通知權限", .english: "Notification Permission Required", .japanese: "通知許可が必要です", .korean: "알림 권한 필요", .spanish: "Se requiere permiso de notificación", .german: "Benachrichtigungsberechtigung erforderlich", .russian: "Требуется разрешение на уведомление", .italian: "Autorizzazione di notifica richiesta"]
        ...
        dict["您已拒绝通知权限。如需打卡提醒，请前往设置中开启。"] = [.chinese: "您已拒绝通知权限。如需打卡提醒，请前往设置中开启。", .traditionalChinese: "您已拒絕通知權限。如需打卡提醒，請前往設定中開啟。", .english: "You have denied notification permissions. To receive check-in reminders, please enable them in Settings.", .japanese: "通知のアクセス許可を拒否しました。チェックインのリマインダーを受け取るには、設定でリマインダーを有効にしてください。", .korean: "알림 권한을 거부했습니다. 체크인 알림을 받으려면 설정에서 활성화하세요.", .spanish: "Ha denegado los permisos de notificación. Para recibir recordatorios de check-in, habilítelos en Configuración.", .german: "Sie haben die Benachrichtigungsberechtigungen verweigert. Um Check-in-Erinnerungen zu erhalten, aktivieren Sie diese bitte in den Einstellungen.", .russian: "Вы отказали в разрешении на уведомления. Чтобы получать напоминания о регистрации, включите их в настройках.", .italian: "Hai negato le autorizzazioni di notifica. Per ricevere promemoria per il check-in, abilitali nelle Impostazioni."]
        ...
        dict["去设置"] = [.chinese: "去设置", .traditionalChinese: "去設定", .english: "Go to Settings", .japanese: "設定に移動", .korean: "설정으로 이동", .spanish: "Ir a configuración", .german: "Gehen Sie zu Einstellungen", .russian: "Зайдите в настройки", .italian: "Vai su Impostazioni"]
        ...
        dict["次数目标"] = [.chinese: "次数目标", .traditionalChinese: "次數目標", .english: "Frequency Goal", .japanese: "頻度の目標", .korean: "빈도 목표", .spanish: "Objetivo de frecuencia", .german: "Häufigkeitsziel", .russian: "Целевая частота", .italian: "Obiettivo di frequenza"]
        ...
        dict["总量目标"] = [.chinese: "总量目标", .traditionalChinese: "總量目標", .english: "Amount Goal", .japanese: "目標金額", .korean: "금액 목표", .spanish: "Objetivo de cantidad", .german: "Betragsziel", .russian: "Сумма цели", .italian: "Obiettivo importo"]
        dict["总数值"] = [.chinese: "总数值", .traditionalChinese: "總數值", .english: "Total Amount", .japanese: "合計金額", .korean: "총액", .spanish: "Monto Total", .german: "Gesamtbetrag", .russian: "Общая сумма", .italian: "Importo totale"]
        ...
        dict["Little Habit Tracker"] = [.chinese: "TickDay", .traditionalChinese: "TickDay", .english: "TickDay", .japanese: "ティックデイ", .korean: "틱데이", .spanish: "TickDay", .german: "TickDay", .russian: "ТикДэй", .italian: "TickDay"]
        ...
        dict["normal"] = [.chinese: "平静", .traditionalChinese: "平靜", .english: "Normal", .japanese: "ノーマル", .korean: "보통", .spanish: "normales", .german: "Normal", .russian: "Нормальный", .italian: "Normale"]
        dict["down"] = [.chinese: "低落", .traditionalChinese: "低落", .english: "Down", .japanese: "ダウン", .korean: "아래로", .spanish: "abajo", .german: "Runter", .russian: "Вниз", .italian: "Giù"]
        dict["angry"] = [.chinese: "生气", .traditionalChinese: "生氣", .english: "Angry", .japanese: "怒っている", .korean: "화난", .spanish: "enojado", .german: "Wütend", .russian: "Злой", .italian: "Arrabbiato"]
        ...
        dict["Little Habit Premium"] = [.chinese: "TickDay 高级版", .traditionalChinese: "TickDay 高級版", .english: "TickDay Premium", .japanese: "TickDay プレミアム", .korean: "틱데이 프리미엄", .spanish: "TickDay Premium", .german: "TickDay Premium", .russian: "ТикДэй Премиум", .italian: "TickDay Premium"]
        ...
        dict["Create as many habits as you want"] = [.chinese: "突破限制，创建任意数量的习惯（免费版最多5个）", .traditionalChinese: "突破限制，創造任意數量的習慣（免費版最多5個）", .english: "Create as many habits as you want (Free version max 5)", .japanese: "好きなだけ習慣を作成できます (無料版では最大 5 つ)", .korean: "원하는 만큼 습관을 만드세요(무료 버전 최대 5개)", .spanish: "Crea tantos hábitos como quieras (versión gratuita máximo 5)", .german: "Erstellen Sie so viele Gewohnheiten, wie Sie möchten (maximal 5 kostenlose Version)", .russian: "Создайте столько привычек, сколько хотите (в бесплатной версии максимум 5)", .italian: "Crea tutte le abitudini che vuoi (Versione gratuita max 5)"]
        ...
        dict["Backup to Excel & Import"] = [.chinese: "备份到 Excel 文件，并支持导入其他 app 打卡记录", .traditionalChinese: "備份到 Excel 文件，並支援匯入其他 app 打卡記錄", .english: "Backup to Excel & import from other apps", .japanese: "Excel へのバックアップと他のアプリからのインポート", .korean: "Excel로 백업 및 다른 앱에서 가져오기", .spanish: "Copia de seguridad en Excel e importación desde otras aplicaciones", .german: "In Excel sichern und aus anderen Apps importieren", .russian: "Резервное копирование в Excel и импорт из других приложений", .italian: "Backup su Excel e importazione da altre app"]
        ...
        dict["试用期间可以随时取消，不扣费"] = [.chinese: "试用期间可以随时取消，不扣费", .traditionalChinese: "試用期間可以隨時取消，不扣費", .english: "Cancel anytime during trial, no charge", .japanese: "お試し中はいつでもキャンセル可能、料金はかかりません", .korean: "체험 기간 중 언제든지 취소 가능, 요금 없음", .spanish: "Cancele en cualquier momento durante la prueba, sin cargo", .german: "Während der Testphase können Sie jederzeit kostenlos kündigen", .russian: "Отмена в любой момент во время пробного периода, бесплатно", .italian: "Annulla in qualsiasi momento durante il periodo di prova, senza alcun costo"]
        ...
        dict["Export Excel Data"] = [.chinese: "导出数据", .traditionalChinese: "匯出數據", .english: "Export Data", .japanese: "データのエクスポート", .korean: "데이터 내보내기", .spanish: "Exportar datos", .german: "Daten exportieren", .russian: "Экспортировать данные", .italian: "Esporta dati"]
        ...
        dict["导出成功！"] = [.chinese: "导出成功！", .traditionalChinese: "匯出成功！", .english: "Export Successful!", .japanese: "エクスポートに成功しました!", .korean: "내보내기 성공!", .spanish: "¡Exportación exitosa!", .german: "Export erfolgreich!", .russian: "Экспорт успешен!", .italian: "Esportazione riuscita!"]
        ...
        dict["打卡提醒"] = [.chinese: "打卡提醒", .traditionalChinese: "打卡提醒", .english: "Reminder", .japanese: "リマインダー", .korean: "알림", .spanish: "Recordatorio", .german: "Erinnerung", .russian: "Напоминание", .italian: "Promemoria"]
        ...
        dict["提醒时间"] = [.chinese: "提醒时间", .traditionalChinese: "提醒時間", .english: "Time", .japanese: "時間", .korean: "시간", .spanish: "tiempo", .german: "Zeit", .russian: "Время", .italian: "Tempo"]
        ...
        dict["自定义文案"] = [.chinese: "自定义文案", .traditionalChinese: "自訂文案", .english: "Custom Message", .japanese: "カスタムメッセージ", .korean: "맞춤 메시지", .spanish: "Mensaje personalizado", .german: "Benutzerdefinierte Nachricht", .russian: "Пользовательское сообщение", .italian: "Messaggio personalizzato"]
        ...
        dict["该打卡啦！坚持就是胜利～"] = [.chinese: "该打卡啦！坚持就是胜利～", .traditionalChinese: "該打卡啦！堅持就是勝利～", .english: "Time to check in! Keep it up~", .japanese: "チェックインの時間です！それを続けてください~", .korean: "체크인 시간입니다! 계속하세요~", .spanish: "¡Es hora de registrarse! Sigue así ~", .german: "Zeit zum Einchecken! Weiter so~", .russian: "Время зарегистрироваться! Так держать~", .italian: "È ora di fare il check-in! Continua così~"]
        ...
        dict["未开启提醒"] = [.chinese: "未开启提醒", .traditionalChinese: "未開啟提醒", .english: "Reminder Disabled", .japanese: "リマインダーが無効になっています", .korean: "알림이 비활성화되었습니다.", .spanish: "Recordatorio deshabilitado", .german: "Erinnerung deaktiviert", .russian: "Напоминание отключено", .italian: "Promemoria disabilitato"]
        ...
        dict["恢复购买成功"] = [.chinese: "恢复购买成功", .traditionalChinese: "恢復購買成功", .english: "Restore Successful", .japanese: "復元に成功しました", .korean: "복원 성공", .spanish: "Restauración exitosa", .german: "Wiederherstellung erfolgreich", .russian: "Восстановить успешно", .italian: "Ripristino riuscito"]
        ...
        dict["没有可恢复的购买项"] = [.chinese: "没有可恢复的购买项", .traditionalChinese: "沒有可恢復的購買項", .english: "No Purchases to Restore", .japanese: "復元する購入はありません", .korean: "복원할 구매가 없습니다.", .spanish: "No hay compras para restaurar", .german: "Keine Käufe zum Wiederherstellen", .russian: "Нет покупок для восстановления", .italian: "Nessun acquisto da ripristinare"]
        ...
        dict["获取产品列表失败："] = [.chinese: "获取产品列表失败：", .traditionalChinese: "取得產品清單失敗：", .english: "Failed to fetch products: ", .japanese: "製品の取得に失敗しました:", .korean: "제품을 가져오지 못했습니다:", .spanish: "No se pudieron recuperar los productos:", .german: "Produkte konnten nicht abgerufen werden:", .russian: "Не удалось получить товары:", .italian: "Impossibile recuperare i prodotti:"]
        ...
        dict["正在购买..."] = [.chinese: "正在购买...", .traditionalChinese: "正在購買...", .english: "Purchasing...", .japanese: "購入中...", .korean: "구매 중...", .spanish: "Comprando...", .german: "Einkauf...", .russian: "Покупка...", .italian: "Acquisto..."]
        ...
        dict["恢复中..."] = [.chinese: "恢复中...", .traditionalChinese: "恢復中...", .english: "Restoring...", .japanese: "復元中...", .korean: "복원 중...", .spanish: "Restaurando...", .german: "Wiederherstellung...", .russian: "Восстановление...", .italian: "Ripristino..."]
        ...
        dict["购买成功！"] = [.chinese: "购买成功！", .traditionalChinese: "購買成功！", .english: "Purchase Successful!", .japanese: "購入成功しました！", .korean: "구매 성공!", .spanish: "¡Compra exitosa!", .german: "Kauf erfolgreich!", .russian: "Покупка успешна!", .italian: "Acquisto riuscito!"]
        ...
        dict["购买被取消"] = [.chinese: "购买被取消", .traditionalChinese: "購買取消", .english: "Purchase Cancelled", .japanese: "購入がキャンセルされました", .korean: "구매가 취소되었습니다.", .spanish: "Compra cancelada", .german: "Kauf storniert", .russian: "Покупка отменена", .italian: "Acquisto annullato"]
        ...
        dict["购买失败"] = [.chinese: "购买失败", .traditionalChinese: "購買失敗", .english: "Purchase Failed", .japanese: "購入に失敗しました", .korean: "구매 실패", .spanish: "Compra fallida", .german: "Der Kauf ist fehlgeschlagen", .russian: "Покупка не удалась", .italian: "Acquisto non riuscito"]
        ...
        dict["恢复购买"] = [.chinese: "恢复购买", .traditionalChinese: "恢復購買", .english: "Restore Purchases", .japanese: "購入を復元する", .korean: "구매 복원", .spanish: "Restaurar compras", .german: "Einkäufe wiederherstellen", .russian: "Восстановить покупки", .italian: "Ripristina gli acquisti"]
        ...
        dict["TickDay 尊享会员"] = [.chinese: "TickDay 尊享会员", .traditionalChinese: "TickDay 尊享會員", .english: "TickDay Premium Member", .japanese: "TickDay プレミアム会員", .korean: "TickDay 프리미엄 회원", .spanish: "Miembro Premium de Tick Day", .german: "TickDay Premium-Mitglied", .russian: "Премиум-участник TickDay", .italian: "Membro Premium di TickDay"]
        ...
        dict["您已是尊享会员"] = [.chinese: "您已是尊享会员", .traditionalChinese: "您已是尊享會員", .english: "You are a Premium Member", .japanese: "あなたはプレミアム会員です", .korean: "당신은 프리미엄 회원입니다", .spanish: "Eres un Miembro Premium", .german: "Sie sind Premium-Mitglied", .russian: "Вы Премиум-участник", .italian: "Sei un membro Premium"]
        ...
        dict["到期时间：永久有效 (终身会员)"] = [.chinese: "到期时间：永久有效 (终身会员)", .traditionalChinese: "到期時間：永久有效 (終身會員)", .english: "Valid until: Lifetime Access", .japanese: "有効期限: 生涯アクセス", .korean: "유효기간: 평생 이용 가능", .spanish: "Válido hasta: Acceso de por vida", .german: "Gültig bis: Lebenslanger Zugriff", .russian: "Действительно до: Пожизненный доступ", .italian: "Valido fino al: Accesso a vita"]
        ...
        dict["状态：已激活尊享会员"] = [.chinese: "状态：已激活尊享会员", .traditionalChinese: "狀態：已啟動尊享會員", .english: "Status: Active Premium", .japanese: "ステータス: アクティブプレミアム", .korean: "상태: 활성 프리미엄", .spanish: "Estado: Premium activo", .german: "Status: Active Premium", .russian: "Статус: Активный Премиум", .italian: "Stato: Premium attivo"]
        ...
        dict["到期时间："] = [.chinese: "到期时间：", .traditionalChinese: "到期時間：", .english: "Valid until: ", .japanese: "有効期限:", .korean: "유효기간:", .spanish: "Válido hasta:", .german: "Gültig bis:", .russian: "Действует до:", .italian: "Valido fino al:"]
        ...
        dict["无法从 App Store 获取产品价格与配置，请检查网络连接或确认苹果后台产品已生效。"] = [.chinese: "无法从 App Store 获取产品价格与配置，请检查网络连接或确认苹果后台产品已生效。", .traditionalChinese: "無法從 App Store 取得產品價格與配置，請檢查網路連線或確認蘋果後台產品已生效。", .english: "Unable to fetch product pricing from App Store. Please check network or App Store Connect status.", .japanese: "App Store から製品の価格を取得できません。ネットワークまたは App Store Connect のステータスを確認してください。", .korean: "App Store에서 제품 가격을 가져올 수 없습니다. 네트워크 또는 App Store 연결 상태를 확인하세요.", .spanish: "No se pueden obtener los precios de los productos en la App Store. Verifique el estado de la red o App Store Connect.", .german: "Produktpreise können nicht aus dem App Store abgerufen werden. Bitte überprüfen Sie den Netzwerk- oder App Store Connect-Status.", .russian: "Не удалось получить цены на продукты из App Store. Пожалуйста, проверьте статус сети или App Store Connect.", .italian: "Impossibile recuperare i prezzi dei prodotti dall'App Store. Controlla lo stato della connessione della rete o dell'App Store."]
        dict["按月扣费"] = [.chinese: "按月扣费", .traditionalChinese: "按月扣費", .english: "Billed monthly", .japanese: "毎月請求される", .korean: "매월 청구됨", .spanish: "Facturado mensualmente", .german: "Wird monatlich abgerechnet", .russian: "Оплата ежемесячно", .italian: "Fatturazione mensile"]
        dict["按年扣费"] = [.chinese: "按年扣费", .traditionalChinese: "按年扣費", .english: "Billed yearly", .japanese: "毎年請求される", .korean: "매년 청구됨", .spanish: "Facturado anualmente", .german: "Jährliche Abrechnung", .russian: "Оплата ежегодно", .italian: "Fatturato annualmente"]
        dict["一次性付费"] = [.chinese: "一次性付费", .traditionalChinese: "一次性付費", .english: "One-time payment", .japanese: "1回払い", .korean: "일회성 결제", .spanish: "Pago único", .german: "Einmalige Zahlung", .russian: "Единовременный платеж", .italian: "Pagamento una tantum"]
        ...
        dict["自动续期，{price}，可随时取消"] = [.chinese: "自动续期，{price}，可随时取消", .traditionalChinese: "自動續期，{price}，可隨時取消", .english: "Auto-renewable, {price}, cancel anytime", .japanese: "自動更新可能、{price}、いつでもキャンセル可能", .korean: "자동 갱신 가능, {price}, 언제든지 취소", .spanish: "Renovable automáticamente, {price}, cancelar en cualquier momento", .german: "Automatisch verlängerbar, {price}, jederzeit kündbar", .russian: "Автоматическое продление, {price}, отмена в любое время", .italian: "Rinnovabile automaticamente, {price}, annulla in qualsiasi momento"]
        ...
        dict["首月免费，结束后按 {price}收费"] = [.chinese: "首月免费，结束后按 {price}收费", .traditionalChinese: "第一個月免費，結束後按 {price}收費", .english: "First month free, then {price}", .japanese: "最初の 1 か月間は無料、その後は {price}", .korean: "첫 달은 무료, 그 이후에는 {price}", .spanish: "Primer mes gratis, luego {price}", .german: "Erster Monat kostenlos, dann {price}", .russian: "Первый месяц бесплатно, затем {price}", .italian: "Primo mese gratis, poi {price}"]
        ...
        dict["一次性付费，永久解锁全部尊享权益"] = [.chinese: "一次性付费，永久解锁全部尊享权益", .traditionalChinese: "一次性付費，永久解鎖全部尊享權益", .english: "One-time payment, lifetime access to all features", .japanese: "1 回限りの支払いで、すべての機能に生涯アクセスできます", .korean: "일회성 결제, 평생 모든 기능 이용 가능", .spanish: "Pago único, acceso de por vida a todas las funciones", .german: "Einmalige Zahlung, lebenslanger Zugriff auf alle Funktionen", .russian: "Единоразовый платеж, пожизненный доступ ко всем функциям", .italian: "Pagamento una tantum, accesso illimitato a tutte le funzionalità"]
        ...
        dict["确认购买后，款项将从您的 iTunes 账户扣除。订阅将自动续期，除非在当前订阅期结束前至少24小时关闭自动续订。您的账户将在当前订阅期结束前24小时内扣取续订费用。您可以在购买后前往 App Store 账户设置中管理或取消您的订阅。"] = [.chinese: "确认购买后，款项将从您的 iTunes 账户扣除。订阅将自动续期，除非在当前订阅期结束前至少24小时关闭自动续订。您的账户将在当前订阅期结束前24小时内扣取续订费用。您可以在购买后前往 App Store 账户设置中管理或取消您的订阅。", .traditionalChinese: "確認購買後，款項將從您的 iTunes 帳戶扣除。訂閱將自動續期，除非在目前訂閱期結束前至少24小時關閉自動續訂。您的帳戶將在目前訂閱期結束前24小時內扣取續訂費用。您可以在購買後前往 App Store 帳戶設定中管理或取消您的訂閱。", .english: "Payment will be charged to your iTunes account at confirmation of purchase. Subscription automatically renews unless auto-renew is turned off at least 24-hours before the end of the current period. Account will be charged for renewal within 24-hours prior to the end of the current period. You can manage and cancel your subscriptions in your App Store account settings.", .japanese: "購入の確認時に、支払いは iTunes アカウントに請求されます。現在の期間が終了する少なくとも 24 時間前に自動更新をオフにしない限り、サブスクリプションは自動的に更新されます。アカウントには、現在の期間が終了する 24 時間以内に更新料金が請求されます。 App Store アカウント設定でサブスクリプションを管理およびキャンセルできます。", .korean: "구매 확인 시 iTunes 계정으로 요금이 청구됩니다. 현재 기간이 종료되기 최소 24시간 전에 자동 갱신을 끄지 않으면 구독이 자동으로 갱신됩니다. 현재 기간이 종료되기 24시간 이내에 갱신 비용이 계정에 청구됩니다. App Store 계정 설정에서 구독을 관리하고 취소할 수 있습니다.", .spanish: "El pago se cargará a su cuenta de iTunes al confirmar la compra. La suscripción se renueva automáticamente a menos que se desactive la renovación automática al menos 24 horas antes del final del período actual. Se cargará a la cuenta la renovación dentro de las 24 horas anteriores al final del período actual. Puede administrar y cancelar sus suscripciones en la configuración de su cuenta de App Store.", .german: "Die Zahlung wird Ihrem iTunes-Konto bei der Kaufbestätigung belastet. Das Abonnement verlängert sich automatisch, es sei denn, die automatische Verlängerung wird mindestens 24 Stunden vor dem Ende des aktuellen Zeitraums deaktiviert. Die Verlängerung des Kontos wird innerhalb von 24 Stunden vor dem Ende des aktuellen Zeitraums belastet. Sie können Ihre Abonnements in den Einstellungen Ihres App Store-Kontos verwalten und kündigen.", .russian: "Оплата будет снята с вашей учетной записи iTunes при подтверждении покупки. Подписка продлевается автоматически, если автоматическое продление не отключено по крайней мере за 24 часа до окончания текущего периода. С аккаунта будет взиматься плата за продление в течение 24 часов до окончания текущего периода. Вы можете управлять своими подписками и отменять их в настройках учетной записи App Store.", .italian: "Il pagamento verrà addebitato sul tuo account iTunes alla conferma dell'acquisto. L'abbonamento si rinnova automaticamente a meno che il rinnovo automatico non venga disattivato almeno 24 ore prima della fine del periodo corrente. Il rinnovo verrà addebitato sul conto entro 24 ore prima della fine del periodo corrente. Puoi gestire e annullare i tuoi abbonamenti nelle impostazioni del tuo account App Store."]
        ...
        dict["提示"] = [.chinese: "提示", .traditionalChinese: "提示", .english: "Notice", .japanese: "お知らせ", .korean: "공지사항", .spanish: "Aviso", .german: "Hinweis", .russian: "Уведомление", .italian: "Avviso"]
        dict["确定"] = [.chinese: "确定", .traditionalChinese: "確定", .english: "OK", .japanese: "OK", .korean: "알았어", .spanish: "bien", .german: "Okay", .russian: "ОК", .italian: "Va bene"]
        ...
        dict["一键生成今年模拟打卡数据"] = [.chinese: "一键生成今年模拟打卡数据", .traditionalChinese: "一鍵生成今年模擬打卡數據", .english: "Generate Mock Data for This Year", .japanese: "今年のモックデータを生成する", .korean: "올해의 모의 데이터 생성", .spanish: "Genere datos simulados para este año", .german: "Generieren Sie Scheindaten für dieses Jahr", .russian: "Сгенерируйте фиктивные данные за этот год", .italian: "Genera dati fittizi per quest'anno"]
        ...
        dict["为现有习惯随机填充今年打卡与情绪记录"] = [.chinese: "为现有习惯随机填充今年打卡与情绪记录", .traditionalChinese: "為現有習慣隨機填滿今年打卡與情緒紀錄", .english: "Populate realistic 2026 check-ins and mood records", .japanese: "現実的な 2026 年のチェックインと気分の記録を取り込む", .korean: "현실적인 2026년 체크인 및 기분 기록 채우기", .spanish: "Complete registros de estado de ánimo y registros realistas de 2026", .german: "Füllen Sie realistische Check-ins und Stimmungsaufzeichnungen für 2026 aus", .russian: "Заполните реалистичные записи о посещениях и настроении на 2026 год.", .italian: "Compila check-in realistici e record dell'umore del 2026"]
        ...
        dict["已为所有习惯成功生成今年全套模拟打卡与情绪数据！"] = [.chinese: "已为所有习惯成功生成今年全套模拟打卡与情绪数据！", .traditionalChinese: "已為所有習慣成功產生今年全套模擬打卡與情緒數據！", .english: "Successfully generated mock check-ins & mood records for this year!", .japanese: "今年の模擬チェックインと気分記録が正常に生成されました。", .korean: "올해의 모의 체크인 및 기분 기록을 성공적으로 생성했습니다!", .spanish: "¡Se generaron con éxito registros simulados y registros de estado de ánimo para este año!", .german: "Für dieses Jahr wurden erfolgreich Mock-Check-Ins und Stimmungsaufzeichnungen generiert!", .russian: "Успешно созданы пробные проверки и записи настроения за этот год!", .italian: "Check-in simulati e record dell'umore generati con successo per quest'anno!"]
        ...
        dict["iCloud 账号正常连接"] = [.chinese: "iCloud 账号正常连接", .traditionalChinese: "iCloud 帳號正常連接", .english: "iCloud Connected", .japanese: "iCloud接続済み", .korean: "iCloud에 연결됨", .spanish: "iCloud conectado", .german: "iCloud verbunden", .russian: "iCloud подключен", .italian: "iCloud connesso"]
        ...
        dict["未登录，请在系统设置中登录您的 Apple ID"] = [.chinese: "未登录，请在系统设置中登录您的 Apple ID", .traditionalChinese: "未登錄，請在系統設定中登入您的 Apple ID", .english: "Not logged in. Please sign in to iCloud in Settings.", .japanese: "ログインしていません。設定で iCloud にサインインしてください。", .korean: "로그인되지 않았습니다. 설정에서 iCloud에 로그인하세요.", .spanish: "No ha iniciado sesión. Inicie sesión en iCloud en Configuración.", .german: "Nicht angemeldet. Bitte melden Sie sich in den Einstellungen bei iCloud an.", .russian: "Не выполнен вход. Войдите в iCloud в настройках.", .italian: "Accesso non effettuato. Accedi a iCloud nelle Impostazioni."]
        ...
        dict["iCloud 访问受限"] = [.chinese: "iCloud 访问受限", .traditionalChinese: "iCloud 存取受限", .english: "iCloud Access Restricted", .japanese: "iCloudアクセスが制限されています", .korean: "iCloud 액세스 제한됨", .spanish: "Acceso restringido a iCloud", .german: "iCloud-Zugriff eingeschränkt", .russian: "Доступ к iCloud ограничен", .italian: "Accesso iCloud limitato"]
        ...
        dict["无法确定 iCloud 状态"] = [.chinese: "无法确定 iCloud 状态", .traditionalChinese: "無法確定 iCloud 狀態", .english: "Could Not Determine iCloud Status", .japanese: "iCloudのステータスを特定できませんでした", .korean: "iCloud 상태를 확인할 수 없음", .spanish: "No se pudo determinar el estado de iCloud", .german: "Der iCloud-Status konnte nicht ermittelt werden", .russian: "Не удалось определить статус iCloud", .italian: "Impossibile determinare lo stato di iCloud"]
        ...
        dict["iCloud 服务暂不可用"] = [.chinese: "iCloud 服务暂不可用", .traditionalChinese: "iCloud 服務暫不可用", .english: "iCloud Temporarily Unavailable", .japanese: "iCloudが一時的に利用できなくなる", .korean: "iCloud를 일시적으로 사용할 수 없음", .spanish: "iCloud no disponible temporalmente", .german: "iCloud vorübergehend nicht verfügbar", .russian: "iCloud временно недоступен", .italian: "iCloud temporaneamente non disponibile"]
        ...
        dict["未知状态"] = [.chinese: "未知状态", .traditionalChinese: "未知狀態", .english: "Unknown Status", .japanese: "不明なステータス", .korean: "알 수 없는 상태", .spanish: "Estado desconocido", .german: "Unbekannter Status", .russian: "Неизвестный статус", .italian: "Stato sconosciuto"]
        ...
        dict["iCloud 状态"] = [.chinese: "iCloud 状态", .traditionalChinese: "iCloud 狀態", .english: "iCloud Status", .japanese: "iCloudのステータス", .korean: "아이클라우드 상태", .spanish: "Estado de iCloud", .german: "iCloud-Status", .russian: "Статус iCloud", .italian: "Stato dell'iCloud"]
        ...
        dict["立即检查同步"] = [.chinese: "立即检查同步", .traditionalChinese: "立即檢查同步", .english: "Check Sync Now", .japanese: "今すぐ同期をチェックする", .korean: "지금 동기화 확인", .spanish: "Marque Sincronizar ahora", .german: "Aktivieren Sie „Jetzt synchronisieren“.", .russian: "Проверить синхронизацию сейчас", .italian: "Controlla Sincronizza ora"]
        ...
        dict["状态检查中..."] = [.chinese: "状态检查中...", .traditionalChinese: "狀態檢查中...", .english: "Checking Status...", .japanese: "ステータスを確認中...", .korean: "상태 확인 중...", .spanish: "Comprobando estado...", .german: "Status wird geprüft...", .russian: "Проверка статуса...", .italian: "Verifica dello stato..."]
        ...
        dict["请长按编辑选择习惯"] = [.chinese: "请长按编辑选择习惯", .traditionalChinese: "請長按編輯選擇習慣", .english: "Please long press to edit & select habit", .japanese: "長押しして習慣を編集して選択してください", .korean: "습관을 수정하고 선택하려면 길게 누르세요.", .spanish: "Mantenga presionado para editar y seleccionar el hábito", .german: "Bitte lange drücken, um die Gewohnheit zu bearbeiten und auszuwählen", .russian: "Пожалуйста, нажмите и удерживайте, чтобы изменить и выбрать привычку", .italian: "Premere a lungo per modificare e selezionare l'abitudine"]
        ...
        dict["本周"] = [.chinese: "本周", .traditionalChinese: "本週", .english: "This week", .japanese: "今週", .korean: "이번 주", .spanish: "esta semana", .german: "Diese Woche", .russian: "На этой неделе", .italian: "Questa settimana"]
        ...
        dict["本月"] = [.chinese: "本月", .traditionalChinese: "本月", .english: "This month", .japanese: "今月", .korean: "이번 달", .spanish: "este mes", .german: "Diesen Monat", .russian: "В этом месяце", .italian: "Questo mese"]
        dict["周"] = [.chinese: "周", .traditionalChinese: "週", .english: "Week", .japanese: "週", .korean: "주", .spanish: "Semana", .german: "Woche", .russian: "неделя", .italian: "Settimana"]
        dict["月"] = [.chinese: "月", .traditionalChinese: "月", .english: "Month", .japanese: "月", .korean: "월", .spanish: "Mes", .german: "Monat", .russian: "Месяц", .italian: "Mese"]
        dict["年"] = [.chinese: "年", .traditionalChinese: "年", .english: "Year", .japanese: "年", .korean: "연도", .spanish: "Año", .german: "Jahr", .russian: "Год", .italian: "Anno"]

        dict[L10n.csvHeaders] = [.chinese: "习惯名称,颜色编号,图标编号,频率类型,目标类型,打卡日期,打卡数值", .traditionalChinese: "習慣名稱,顏色編號,圖標編號,頻率類型,目標類型,打卡日期,打卡數值", .traditionalChinese: "習慣名稱,顏色編號,圖示編號,頻率類型,目標類型,打卡日期,打卡數值\", .traditionalChinese: \"習慣名稱,顏色編號,圖示編號,頻率類型,目標類型,打卡日期,打卡數值", .english: "Habit Name,Color Hex,Icon Name,Frequency Type,Goal Type,Check-in Date,Amount", .japanese: "習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量", .korean: "습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양", .spanish: "Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad", .german: "Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge", .russian: "Название привычки,Шестнадцатеричный цвет,Название значка,Тип частоты,Тип цели,Дата отметки,Количество", .italian: "Nome abitudine,Esadecimale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità", .japanese: "習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,金額\", .japanese: \"習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量\", .韓国語: \"습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .ドイツ語: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название значка,Тип частоты,Тип цели,Дата отметки,Количество\", .italian: \"Nome abitudine,Esadecmale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità", .korean: "습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,금액\", .japanese: \"習慣name,kara-16進数,aiconnname,頻titudetaiph,目標taiph,CHECKIN日,weight\", .korean: \"습관 이름,색상 16진수, 이름,아이콘빈도 입력, 목표 유형, 체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .german: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название значка,Тип частоты,Тип цели,Дата отметки,Количество\", .italian: \"Nome abitudine,Esadecimale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità", .spanish: "Nombre del hábito, Color hexadecimal, Nombre del icono, Tipo de frecuencia, Tipo de objetivo, Fecha de entrada, Importe\", .japanese: \"習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量\", .coreano: \"습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .german: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название значка,Тип частоты,Тип цели,Дата отметки,Количество\", .italiano: \"Nome abitudine,Esadecimale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità", .german: "Gewohnheitsname, Farbe Hex, Symbolname, Häufigkeitstyp, Zieltyp, Check-in-Datum, Betrag\", .japanisch: „習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量“, .koreanisch: „습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .german: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название .italian: „Abiturname, Farbcode, Symbolname, Frequenztyp, Zielwert, Registrierungsdaten, Menge", .russian: "Название привычки, шестнадцатеричный цвет, имя значка, тип частоты, тип цели, дата заезда, сумма\", .japanese: \"習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量\", .korean: \"습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .german: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название значка,Тип формы,Тип цели,Дата отметки,Количество\", .italian: \"Имя abitudine,Esadecimale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità", .italian: "Nome abitudine, Colore esadecimale, Nome icona, Tipo di frequenza, Tipo di obiettivo, Data di check-in, Importo\", .giapponese: \"習慣名,カラー16進数,アイコン名,頻度タイプ,目標タイプ,チェックイン日,量\", .korean: \"습관 이름,색상 16진수,아이콘 이름,빈도 유형,목표 유형,체크인 날짜,양\", .spanish: \"Nombre del hábito,Color Hex,Nombre del icono,Tipo de frecuencia,Tipo de objetivo,Fecha de registro,Cantidad\", .german: \"Gewohnheitsname,Farb-Hex,Symbolname,Häufigkeitstyp,Zieltyp,Check-in-Datum,Menge\", .russian: \"Название привычки,Шестнадцатеричный цвет,Название значка,Тип частоты,Тип цели,Дата отметки,Количество\", .italian: \"Nome abitudine,Esadecimale colore,Nome icona,Tipo di frequenza,Tipo di obiettivo,Data di registrazione,Quantità"]
        dict[L10n.noRecords] = [.chinese: "暂无记录", .traditionalChinese: "暫無記錄", .traditionalChinese: "暫無記錄\", .traditionalChinese: \"暫無記錄", .english: "No records", .japanese: "記録なし", .korean: "기록 없음", .spanish: "Sin registros", .german: "Keine Aufzeichnungen", .russian: "Нет записей", .italian: "Nessun record", .japanese: "記録がありません\"、.日本語: \"記録なし\"、.韓国語: \"기록 없음\"、.スペイン語: \"Sin registros\"、.ドイツ語: \"Keine Aufzeichnungen\"、.russian: \"Нет записей\"、.italian: \"Nessun Record", .korean: "No records\", .japanese: \"記録なし\", .korean: \"기록 없음\", .spanish: \"Sin registros\", .german: \"Keine Aufzeichnungen\", .russian: \"Нет записей\", .italian: \"Nessun 기록", .spanish: "Sin registros\", .japonés: \"記録なし\", .coreano: \"기록 없음\", .español: \"Sin registros\", .alemán: \"Keine Aufzeichnungen\", .ruso: \"Нет записей\", .italiano: \"Nessun record", .german: "Keine Aufzeichnungen“, .japanisch: „記録なし“, .koreanisch: „기록 없음“, .spanisch: „Sin registros“, .deutsch: „Keine Aufzeichnungen“, .russisch: „Нет записей“, .italienisch: „Nessun-Aufzeichnung", .russian: "Нет записей\", .японский: \"記録なし\", .корейский: \"기록 없음\", .испанский: \"Sin registros\", .немецкий: \"Keine Aufzeichnungen\", .русский: \"Нет записей\", .итальянский: \"Запись Nessun", .italian: "No records\", .japanese: \"記録なし\", .korean: \"기록 없음\", .spanish: \"Sin registros\", .german: \"Keine Aufzeichnungen\", .russian: \"Нет записей\", .italian: \"Nessun record"]
        return dict
