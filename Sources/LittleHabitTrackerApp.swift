...
extension String {
    func tr(_ lang: AppLanguage) -> String {
        let translations: [String: [AppLanguage: String]] = [
            ...
            "Search for 'TickDay' and add your favorite widget.": [.chinese: "搜索“TickDay”，选择并添加你喜欢的小组件", .english: "Search for 'TickDay' and add your favorite widget."],
            ...
            "Tap '+' in top left, search 'TickDay', and tap 'Add Widget'.": [.chinese: "点击左上角的“+”按钮，搜索“TickDay”，点击“添加小组件”按钮", .english: "Tap '+' in top left, search 'TickDay', and tap 'Add Widget'."],
